...
%% 逐样本执行推理
for n = 1:T
    % 🌟【核心修正】TrainData 只有 4 列：第 1:2 列属于子库1，第 3:4 列属于子库2
    feat_brb1 = TrainData(n, 1:2); 
    feat_brb2 = TrainData(n, 3:4);
...
f = sqrt(mean((Final_Outputs - TrainLabels).^2));
end
